...
import { scanEvent, scanTicketDetail } from '../redux/features/eventSlice';
...
const ScanTicketDetail = () => {
    ...
    const onSuccess = async (e) => {
        ...
        try {
            ...
            const response = await dispatch(scanTicketDetail(data));
...
export default ScanTicketDetail;
